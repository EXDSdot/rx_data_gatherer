...
def _transform_emerge(val: Any) -> int | None:
    # 1 if yes, 0 if no (different from yes_no which uses 1/2)
    s = _clean_str(val)
    if s == "yes": return 1
    if s == "no": return 0
    return None
